...
direction. Run \path{run_20260616T132519_943745+0000}.}
\label{tab:attack}
\small
\begin{tabular}{@{}llccc@{}}
\toprule
...
run (\path{run_20260616T033459_717474+0000}) predates the band-shift field; shifts recomputed
from saved scores.}
\label{tab:dilution}
\small
\begin{tabular}{@{}lcc@{}}
...
\path{run_20260617T090409_203299+0000}. FP = honest source flagged on clean input.}
\label{tab:defense}
\small
...
\toprule
Model Tag & Digest (short) & M4 Run Dir. & M5 Run Dir. & Attack (M4) & Detection (M5) & Recovery (M5) & FP (M5) \\
\midrule
\texttt{llama3:8b}   & \texttt{365c0bd3c000a25d28d\dots} & \path{run_20260616T132519_943745+0000} & \path{run_20260617T090409_203299+0000} & 8/8 & 8/8 & 8/8 (1.00) & 0/8 (0.00) \\
\texttt{qwen2.5:7b}  & \texttt{845dbda0ea48ed749ca\dots} & \path{run_20260828T041137_406624+0000} & \path{run_20260828T042138_087817+0000} & 7/8 & 7/8 & 7/8 (0.88) & 0/8 (0.00) \\
\texttt{mistral:7b}  & \texttt{6577803aa9a036369e4\dots} & \path{run_20260826T104715_442613+0000} & \path{run_20260826T125402_554702+0000} & 4/8 & 7/8 & 8/8 (1.00) & 0/8 (0.00) \\
\bottomrule
\end{tabular}
\end{table*}
...
\path{CVSS:3.1/AV:N/AC:L/Au:N/C:C/I:C/A:H} (the \texttt{Au:N} field is v2). We
...
(run \path{run_20260824T082827_560584+0000}).
...
\path{a87433bf09e381fc8b383baeb79ef6ffce9b30ea}).
