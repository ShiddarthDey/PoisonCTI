...
\midrule
\multicolumn{6}{@{}l}{Detection 8/8, recovery 8/8 (1.00), FP 0/8 (0.00)} \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{table*}[t]
\centering
\caption{Cross-model replication summary across three open-weight models ($n=8$ synthetic CVEs per model). Pinned model digests from \texttt{config/models.lock.json}; run directory names cited from experiment logs. Run directories abbreviated to timestamp; full names and pinned digests are in the repository (\texttt{config/models.lock.json}).}
\label{tab:cross-model}
\footnotesize
\setlength{\tabcolsep}{4pt}
\begin{tabular}{@{}lllcccc@{}}
\toprule
Model Tag & M4 Run & M5 Run & Attack & Detection & Recovery & FP \\
\midrule
\texttt{llama3:8b}  & \path{run_20260616T132519} & \path{run_20260617T090409} & 8/8 & 8/8 & 8/8 (1.00) & 0/8 (0.00) \\
\texttt{qwen2.5:7b} & \path{run_20260828T041137} & \path{run_20260828T042138} & 7/8 & 7/8 & 7/8 (0.88) & 0/8 (0.00) \\
\texttt{mistral:7b} & \path{run_20260826T104715} & \path{run_20260826T125402} & 4/8 & 7/8 & 8/8 (1.00) & 0/8 (0.00) \\
\bottomrule
\end{tabular}
\end{table*}
